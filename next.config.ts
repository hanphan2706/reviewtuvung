...
const nextConfig: NextConfig = {
  ...
  outputFileTracingIncludes: {
    "/*": [
      ...
      "./reading raw/de-thi-that-2.txt",
      "./reading raw/de-thi-that-3.txt",
      "./reading raw/de-thi-that-4.txt",
      "./reading raw/de-thi-that-5.txt",
      "./reading raw/de-thi-that-6.txt",
      "./reading raw/de-thi-that-7.txt",
      "./reading raw/de-thi-that-8.txt",
      "./reading raw/de-thi-that-9.txt",
      "./reading raw/de-thi-that-10.txt",
      ...
      "./listening materials/real test 2 qna.txt",
      "./listening materials/real test 2 answers.txt",
      "./listening materials/real test 2 part 3 map.jpg",
      "./listening materials/transcript/real test 2.txt",
      "./listening materials/transcript/real-test-2.cleaned.txt",
      "./listening materials/sync/real-test-2.sync.json",
      "./listening materials/real test 3 qna.txt",
      "./listening materials/real test 3 answers.txt",
      "./listening materials/transcript/real test 3.txt",
      "./listening materials/transcript/real-test-3.cleaned.txt",
      "./listening materials/sync/real-test-3.sync.json",
      "./listening materials/real test 4 qna.txt",
      "./listening materials/real test 4 answers.txt",
      "./listening materials/transcript/real test 4.txt",
      "./listening materials/transcript/real-test-4.cleaned.txt",
      "./listening materials/sync/real-test-4.sync.json",
      "./reading explanations/de-thi-that-1.json",
      "./reading explanations/de-thi-that-2.json",
      "./reading explanations/de-thi-that-3.json",
      "./reading explanations/de-thi-that-4.json",
      "./reading explanations/de-thi-that-5.json",
      "./reading explanations/de-thi-that-6.json",
      "./reading explanations/de-thi-that-7.json",
      "./reading explanations/de-thi-that-8.json",
      "./reading explanations/de-thi-that-9.json",
      "./reading explanations/de-thi-that-10.json",
      "./reading translations/de-thi-that-*.vi.json",
