...
/** Tách đoạn khi copy từ nhiều block (có thể chỉ có \n đơn, không phải \n\n). */
...
export function shouldApplyCopyFriction(text: string): boolean {
...
export function applyCopyFriction(text: string): string {
