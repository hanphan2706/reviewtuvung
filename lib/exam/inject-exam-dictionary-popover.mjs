...
.exam-review-dict-hint{
  display:block;width:100%;margin:6px 12px 8px;padding:0;font-size:13px;font-weight:600;line-height:1.35;
  font-style:italic;color:#4b2876;flex:1 0 100%;text-align:left;white-space:normal
}
...
#part-tabs.exam-review-dict-bar{
  display:flex;align-items:center;flex-wrap:wrap;gap:0;overflow:visible;padding-right:4px
}
