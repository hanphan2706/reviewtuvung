...
const CAM14_TEST1_QNA: ListeningQnaFileRef = {
  fileName: "cam 14 test 1 qna.txt",
  test: 1,
};

const CAM14_TEST2_QNA: ListeningQnaFileRef = {
  fileName: "cam 14 test 2 qna.txt",
  test: 2,
};

const CAM14_TEST3_QNA: ListeningQnaFileRef = {
  fileName: "cam 14 test 3 qna.txt",
  test: 3,
};

const CAM14_TEST4_QNA: ListeningQnaFileRef = {
  fileName: "cam 14 test 4 qna.txt",
  test: 4,
};
...
const CAM13_TEST2_QNA: ListeningQnaFileRef = {
  fileName: "cam 13 test 2 qna.txt",
  test: 2,
};

const CAM13_TEST3_QNA: ListeningQnaFileRef = {
  fileName: "cam 13 test 3 qna.txt",
  test: 3,
};

const CAM13_TEST4_QNA: ListeningQnaFileRef = {
  fileName: "cam 13 test 4 qna.txt",
  test: 4,
};

const CAM15_TEST1_QNA: ListeningQnaFileRef = {
  fileName: "cam 15 test 1 qna.txt",
  test: 1,
};

const CAM15_TEST2_QNA: ListeningQnaFileRef = {
  fileName: "cam 15 test 2 qna.txt",
  test: 2,
};

const CAM15_TEST3_QNA: ListeningQnaFileRef = {
  fileName: "cam 15 test 3 qna.txt",
  test: 3,
};

const CAM15_TEST4_QNA: ListeningQnaFileRef = {
  fileName: "cam 15 test 4 qna.txt",
  test: 4,
};

const CAM16_TEST1_QNA: ListeningQnaFileRef = {
  fileName: "cam 16 test 1 qna.txt",
  test: 1,
};

const CAM16_TEST2_QNA: ListeningQnaFileRef = {
  fileName: "cam 16 test 2 qna.txt",
  test: 2,
};

const CAM16_TEST3_QNA: ListeningQnaFileRef = {
  fileName: "cam 16 test 3 qna.txt",
  test: 3,
};

const CAM16_TEST4_QNA: ListeningQnaFileRef = {
  fileName: "cam 16 test 4 qna.txt",
  test: 4,
};
...
export const LISTENING_TEST_QNA: Record<string, ListeningQnaFileRef> = {
  ...
  "cam16-test1": CAM16_TEST1_QNA,
  "cam16-test2": CAM16_TEST2_QNA,
  "cam16-test3": CAM16_TEST3_QNA,
  "cam16-test4": CAM16_TEST4_QNA,
  "cam15-test1": CAM15_TEST1_QNA,
  "cam15-test2": CAM15_TEST2_QNA,
  "cam15-test3": CAM15_TEST3_QNA,
  "cam15-test4": CAM15_TEST4_QNA,
  "cam14-test1": CAM14_TEST1_QNA,
  "cam14-test2": CAM14_TEST2_QNA,
  "cam14-test3": CAM14_TEST3_QNA,
  "cam14-test4": CAM14_TEST4_QNA,
  "cam13-test1": CAM13_TEST1_QNA,
...
export const LISTENING_PART_QNA: Record<string, ListeningPartQnaRef> = {
  ...
  "cam15-t1-p1": { ...CAM15_TEST1_QNA, part: 1 },
  "cam15-t1-p2": { ...CAM15_TEST1_QNA, part: 2 },
  "cam15-t1-p3": { ...CAM15_TEST1_QNA, part: 3 },
  "cam15-t1-p4": { ...CAM15_TEST1_QNA, part: 4 },
  "cam15-t2-p1": { ...CAM15_TEST2_QNA, part: 1 },
  "cam15-t2-p2": { ...CAM15_TEST2_QNA, part: 2 },
  "cam15-t2-p3": { ...CAM15_TEST2_QNA, part: 3 },
  "cam15-t2-p4": { ...CAM15_TEST2_QNA, part: 4 },
  "cam15-t3-p1": { ...CAM15_TEST3_QNA, part: 1 },
  "cam15-t3-p2": { ...CAM15_TEST3_QNA, part: 2 },
  "cam15-t3-p3": { ...CAM15_TEST3_QNA, part: 3 },
  "cam15-t3-p4": { ...CAM15_TEST3_QNA, part: 4 },
  "cam15-t4-p1": { ...CAM15_TEST4_QNA, part: 1 },
  "cam15-t4-p2": { ...CAM15_TEST4_QNA, part: 2 },
  "cam15-t4-p3": { ...CAM15_TEST4_QNA, part: 3 },
  "cam15-t4-p4": { ...CAM15_TEST4_QNA, part: 4 },
  "cam14-t1-p1": { ...CAM14_TEST1_QNA, part: 1 },
  "cam14-t1-p2": { ...CAM14_TEST1_QNA, part: 2 },
  "cam14-t1-p3": { ...CAM14_TEST1_QNA, part: 3 },
  "cam14-t1-p4": { ...CAM14_TEST1_QNA, part: 4 },
  "cam14-t2-p1": { ...CAM14_TEST2_QNA, part: 1 },
  "cam14-t2-p2": { ...CAM14_TEST2_QNA, part: 2 },
  "cam14-t2-p3": { ...CAM14_TEST2_QNA, part: 3 },
  "cam14-t2-p4": { ...CAM14_TEST2_QNA, part: 4 },
  "cam14-t3-p1": { ...CAM14_TEST3_QNA, part: 1 },
  "cam14-t3-p2": { ...CAM14_TEST3_QNA, part: 2 },
  "cam14-t3-p3": { ...CAM14_TEST3_QNA, part: 3 },
  "cam14-t3-p4": { ...CAM14_TEST3_QNA, part: 4 },
  "cam14-t4-p1": { ...CAM14_TEST4_QNA, part: 1 },
  "cam14-t4-p2": { ...CAM14_TEST4_QNA, part: 2 },
  "cam14-t4-p3": { ...CAM14_TEST4_QNA, part: 3 },
  "cam14-t4-p4": { ...CAM14_TEST4_QNA, part: 4 },
  "cam13-t1-p1": { ...CAM13_TEST1_QNA, part: 1 },
  "cam13-t1-p2": { ...CAM13_TEST1_QNA, part: 2 },
  "cam13-t1-p3": { ...CAM13_TEST1_QNA, part: 3 },
  "cam13-t1-p4": { ...CAM13_TEST1_QNA, part: 4 },
  "cam13-t2-p1": { ...CAM13_TEST2_QNA, part: 1 },
  "cam13-t2-p2": { ...CAM13_TEST2_QNA, part: 2 },
  "cam13-t2-p3": { ...CAM13_TEST2_QNA, part: 3 },
  "cam13-t2-p4": { ...CAM13_TEST2_QNA, part: 4 },
  "cam13-t3-p1": { ...CAM13_TEST3_QNA, part: 1 },
  "cam13-t3-p2": { ...CAM13_TEST3_QNA, part: 2 },
  "cam13-t3-p3": { ...CAM13_TEST3_QNA, part: 3 },
  "cam13-t3-p4": { ...CAM13_TEST3_QNA, part: 4 },
  "cam13-t4-p1": { ...CAM13_TEST4_QNA, part: 1 },
  ...
  "cam16-t1-p4": { ...CAM16_TEST1_QNA, part: 4 },
  "cam16-t2-p1": { ...CAM16_TEST2_QNA, part: 1 },
  "cam16-t2-p2": { ...CAM16_TEST2_QNA, part: 2 },
  "cam16-t2-p3": { ...CAM16_TEST2_QNA, part: 3 },
  "cam16-t2-p4": { ...CAM16_TEST2_QNA, part: 4 },
  "cam16-t3-p1": { ...CAM16_TEST3_QNA, part: 1 },
  "cam16-t3-p2": { ...CAM16_TEST3_QNA, part: 2 },
  "cam16-t3-p3": { ...CAM16_TEST3_QNA, part: 3 },
  "cam16-t3-p4": { ...CAM16_TEST3_QNA, part: 4 },
  "cam16-t4-p1": { ...CAM16_TEST4_QNA, part: 1 },
  "cam16-t4-p2": { ...CAM16_TEST4_QNA, part: 2 },
  "cam16-t4-p3": { ...CAM16_TEST4_QNA, part: 3 },
  "cam16-t4-p4": { ...CAM16_TEST4_QNA, part: 4 },
