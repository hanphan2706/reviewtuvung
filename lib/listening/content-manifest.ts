...
export const LISTENING_TEST_CONTEXTS: Record<string, ListeningTestContext> = {
  ...
  "cam13-t1": {
    ...
    predictBlurb:
      "Trước khi nghe bản đầy đủ của Part này: đoán **tình huống chung** (ai với ai, đang làm gì). Gợi ý rất nhẹ: có thể là lớp nấu ăn, giao thông Granford, thí nghiệm hạt giống hoặc động vật đô thị — không cần đoán đúng chi tiết.",
  },
  "cam13-t2": {
    predictTitle: "Cam 13 — Test 2",
    predictBlurb:
      "Trước khi nghe bản đầy đủ của Part này: đoán **tình huống chung** (ai với ai, đang làm gì). Gợi ý rất nhẹ: có thể là câu lạc bộ xe đạp, tình nguyện công ty, thuyết trình nano hoặc trí nhớ episodic — không cần đoán đúng chi tiết.",
  },
  "cam13-t3": {
    predictTitle: "Cam 13 — Test 3",
    predictBlurb:
      "Trước khi nghe bản đầy đủ của Part này: đoán **tình huống chung** (ai với ai, đang làm gì). Gợi ý rất nhẹ: có thể là chuyển đến Banford, giữ dáng, nhuộm vải tự nhiên hoặc thằn lằn sleepy lizard — không cần đoán đúng chi tiết.",
  },
  "cam13-t4": {
    predictTitle: "Cam 13 — Test 4",
    predictBlurb:
      "Trước khi nghe bản đầy đủ của Part này: đoán **tình huống chung** (ai với ai, đang làm gì). Gợi ý rất nhẹ: có thể là đào tạo Alex, Snow Centre, nhãn dinh dưỡng hoặc lịch sử cà phê — không cần đoán đúng chi tiết.",
  },
  "cam14-t1": {
  ...
  "cam15-t1": {
    ...
    predictBlurb:
      "Trước khi nghe bản đầy đủ của Part này: đoán **tình huống chung** (ai với ai, đang làm gì). Gợi ý rất nhẹ: có thể là agency tuyển dụng, kỳ nghỉ đảo Man, thứ tự sinh trong gia đình hoặc cây bạch đàn Úc — không cần đoán đúng chi tiết.",
  },
  "cam15-t2": {
    predictTitle: "Cam 15 — Test 2",
    predictBlurb:
      "Trước khi nghe bản đầy đủ của Part này: đoán **tình huống chung** (ai với ai, đang làm gì). Gợi ý rất nhẹ: có thể là lễ hội, công viên Minster, trưng bày Dickens hoặc chương trình nông nghiệp Mozambique — không cần đoán đúng chi tiết.",
  },
  "cam15-t3": {
    predictTitle: "Cam 15 — Test 3",
    predictBlurb:
      "Trước khi nghe bản đầy đủ của Part này: đoán **tình huống chung** (ai với ai, đang làm gì). Gợi ý rất nhẹ: có thể là việc làm qua agency, Street Play, phân tích báo của Hazel hoặc lịch sử giữ vệ sinh — không cần đoán đúng chi tiết.",
  },
  "cam15-t4": {
    predictTitle: "Cam 15 — Test 4",
    predictBlurb:
      "Trước khi nghe bản đầy đủ của Part này: đoán **tình huống chung** (ai với ai, đang làm gì). Gợi ý rất nhẹ: có thể là khảo sát khách hàng, công viên Croft Valley, thuyết trình tủ lạnh hoặc Cách mạng Công nghiệp — không cần đoán đúng chi tiết.",
  },
  "cam16-t1": {
