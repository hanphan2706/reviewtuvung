...
- **articleId:** `cam20-test2-p2`
- **Số đoạn:** 13 (bản dịch phải đúng 13 phần tử trong mảng `paragraphs`)

Lưu file: `reading translations/cam20-test2-p2.vi.json`
...
**Yêu cầu dịch:** tiếng Việt tự nhiên, giữ tên riêng/ loài (Manatees → lợn biển hoặc cá nược tùy ngữ cảnh), không gộp hay tách đoạn.
