...
export function AuthButton(props: AuthButtonProps) {
	...
	const menuRowClass =
		"inline-flex cursor-pointer items-center bg-transparent p-0 text-sm font-medium leading-normal shadow-none hover:bg-transparent disabled:pointer-events-none disabled:opacity-45";
