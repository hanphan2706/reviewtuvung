  ...
  return (
    <div className={studyHubSubpageContentClass}>
      <div className="max-w-2xl">
        <h1 className="font-serif text-3xl font-bold tracking-tight text-[#000001] md:text-4xl">{entry.title}</h1>
        ...
        <div className="mt-8 rounded-2xl border border-[#E4E4E7] bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm leading-relaxed text-[#47464b]">
            Lý thuyết, bài tập và thẻ SRS sẽ được bổ sung dần — bạn có thể quay lại sau hoặc thử các unit đã mở.
          </p>
          <Link
